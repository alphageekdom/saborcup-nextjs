...
const About = () => {
  ...
  const breadcrumbItems = [{ title: 'About', path: `${pathname}` }];
          ...
          <TwoColumnSection>
            <div className='md:w-1/2'>
              ...
              <p className='text-base md:text-lg'>
                ...
                coffee and a deep connection to community. Our journey began
                with a vision to create a warm and welcoming environment where
                modern meets Hispanic cultural decor. We aim to bring people
                together through exceptional coffee, baked goods, and monthly
                events.
              </p>
            </div>
          ...
          <TwoColumnSection>
            <div className='md:w-1/2'>
              ...
              <p className='text-base md:text-lg'>
                ...
                with <span className='italic'>Hispanic</span> cultural decor,
                our coffee shop is a unique space to unwind and explore new
                flavors. We are proud to offer high-quality drinks and baked
                goods made from local, high-quality ingredients.
              </p>
            </div>
            <div className='md:w-1/2 flex justify-center'>
              <figure className='relative max-w-sm'>
          ...
          <TwoColumnSection reverseOnMobile>
            <div className='md:w-1/2'>
              ...
              <p className='text-base md:text-lg'>
                ...
                with every cup of coffee. Come meet the wonderful people who
                make it all happen and share our passion for exceptional coffee
                and community.
              </p>
            </div>
            <div className='md:w-1/2 flex justify-center'>
